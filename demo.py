...
app.layout =  html.Div([
    ...
    # html.Div([ html.H2('Stock Price by the Minute (US)' , style = {'position' : 'relative' ,'float' : 'left', 'top' : '15px','left':'50%', 'margin-right':'0'}),
    ...
    #         {'label': 'Nike', 'value': 'NKE'}
    #     ],
    #     value='MSFT' , style = {'width': '49%', 'position' : 'relative' , 'float':'left', 'margin-right':'0' }
    # )
    # , dcc.Graph(id='my-graph', style = {'position' : 'relative' , 'float':'left', 'margin-right':'0' })
    ]),
    ])
    # ])
